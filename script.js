document.addEventListener('DOMContentLoaded', function() {
    // بيانات التطبيقات - تطبيق محول الصيغ فقط
    let apps = [
        {
            id: 1,
            name: "محول الصيغ",
            category: "tools",
            description: "تطبيق تحويل الصيغ جميع الصيغ",
            image: "https://play-lh.googleusercontent.com/TdM1HpnYbU92VlJ8XgYIIZWx4B-eQSv9T0Y-QGIzfuIl4xJROw0M-20NGwY9Qi9-Pg=w240-h480-rw",
            downloadUrl: "https://www.mediafire.com/file/pzjqeskivqo09dt/%25D9%2585%25D8%25AD%25D9%2588%25D9%2584_%25D8%25B5%25D9%258A%25D8%25BA.apk/file"
        }
    ];
    ...
    if (localStorage.getItem('apps')) {
        ...
        // حفظ التطبيقات الافتراضية في التخزين المحلي
